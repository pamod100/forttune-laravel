...
<head>
  ...
  <meta name="description" content="@yield('meta_description', 'Forttune Channels Pvt Ltd — Sri Lanka\'s trusted IT & computer hardware distributor.')" />
  <title>@yield('title', 'Forttune | Technology Provider')</title>
...
<body>
  ...
  <img src="{{ asset('images/logo.png') }}" alt="Forttune Channels Pvt Ltd" class="logo-img">
</a>
      ...
      <div class="header-actions">
        ...
        @auth
          <div class="account-menu">
            <button class="account-btn" id="accountToggle">
              @if (auth()->user()->avatar)
                <img src="{{ auth()->user()->avatar }}" class="account-avatar-img" alt="" />
              @else
        ...
        @else
          <a href="{{ route('login') }}" class="account-btn" title="Log In">
  ...
  <footer class="footer">
    <div class="container footer-inner">
      ...
      <div class="footer-col">
        ...
        @foreach (\App\Models\Category::take(6)->get() as $cat)
          <a href="{{ route('products.index', ['cat' => $cat->slug]) }}">{{ $cat->name }}</a>
        @endforeach
      </div>
      <div class="footer-col">
        <h4>Company</h4>
        <a href="{{ route('home') }}#contact">About Us</a>
        <a href="#">Careers</a>
    ...
    <div class="footer-bottom">
      <div class="container">
        <span>© {{ date('Y') }} Forttune Channels (Pvt) Ltd. All rights reserved.</span>
  ...
  <a href="https://wa.me/{{ config('app.whatsapp_number', '94725516516') }}?text=Hi%20Forttune%2C%20I%27d%20like%20to%20ask%20about%20a%20product."
