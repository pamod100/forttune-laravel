...
<section class="testimonials section" id="services">
  <div class="container">
    ...
    <?php if($testimonials->count() > 0): ?>
      ...
      <div class="gr-summary-card">
        ...
        <div class="gr-score-block">
          <div class="gr-score-number"><?php echo e(number_format($avgRating, 1)); ?></div>
          <div class="gr-score-stars">
            <?php for($i = 1; $i <= 5; $i++): ?>
              <svg class="gr-star <?php echo e($i <= round($avgRating) ? 'filled' : 'empty'); ?>" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 1l2.39 4.84 5.34.78-3.87 3.77.91 5.32L10 13.27l-4.77 2.51.91-5.32L2.27 6.62l5.34-.78z"/>
              </svg>
            <?php endfor; ?>
          </div>
          <div class="gr-score-total"><?php echo e($totalReviews); ?> review<?php echo e($totalReviews > 1 ? 's' : ''); ?></div>
        </div>
        ...
        <div class="gr-bars-block">
          <?php for($s = 5; $s >= 1; $s--): ?>
            <?php $pct = $totalReviews > 0 ? ($starCounts[$s] / $totalReviews) * 100 : 0; ?>
            <div class="gr-bar-row">
              <span class="gr-bar-label"><?php echo e($s); ?></span>
              <svg class="gr-bar-star" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 1l2.39 4.84 5.34.78-3.87 3.77.91 5.32L10 13.27l-4.77 2.51.91-5.32L2.27 6.62l5.34-.78z"/>
              </svg>
              <div class="gr-bar-track">
                <div class="gr-bar-fill" style="width: <?php echo e($pct); ?>%;"></div>
              </div>
              <span class="gr-bar-count"><?php echo e($starCounts[$s]); ?></span>
            </div>
          <?php endfor; ?>
        </div>
      </div>
        ...
        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="gr-card">
            ...
            <div class="gr-card-header">
              <div class="gr-avatar" style="background: <?php echo e($avatarColor); ?>;"><?php echo e($initials); ?></div>
              <div class="gr-card-meta">
                <div class="gr-card-name"><?php echo e($t->name); ?></div>
                <?php if($t->role): ?>
                  <div class="gr-card-role"><?php echo e($t->role); ?></div>
                <?php endif; ?>
              </div>
            ...
            <div class="gr-card-stars-row">
              <div class="gr-card-stars">
                <?php for($i = 1; $i <= 5; $i++): ?>
                  <svg class="gr-star sm <?php echo e($i <= $t->rating ? 'filled' : 'empty'); ?>" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 1l2.39 4.84 5.34.78-3.87 3.77.91 5.32L10 13.27l-4.77 2.51.91-5.32L2.27 6.62l5.34-.78z"/>
                  </svg>
                <?php endfor; ?>
              </div>
              <span class="gr-card-date"><?php echo e($t->created_at->diffForHumans()); ?></span>
            </div>
 
            
            <p class="gr-card-text"><?php echo e($t->message); ?></p>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    ...
    <div style="text-align:center; margin-top:2.5rem;">
      <a href="<?php echo e(route('services')); ?>" class="btn-view-services">View Our Services →</a>
    </div>
