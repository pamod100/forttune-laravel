...
<?php $__env->startSection('content'); ?>
  ...
  <div class="auth-subtitle">Join Forttune to track your orders</div>

  <?php if($errors->any()): ?>
    <div class="auth-alert error"><?php echo e($errors->first()); ?></div>
  <?php endif; ?>
  ...
  <form method="POST" action="<?php echo e(route('register')); ?>" class="auth-form">
    ...
    <div class="form-group">
      ...
      <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Your full name" required autofocus />
    </div>
    <div class="form-group">
      <label>Email Address</label>
      <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="your@email.com" required />
    </div>
    <div class="form-group">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pamod\Downloads\forttune-laravel\forttune-laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>