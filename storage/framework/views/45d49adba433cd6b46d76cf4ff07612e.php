<?php $__env->startSection('title', 'Cart & Checkout | Forttune Channels'); ?>
      ...
      <div class="order-summary">
        ...
        <div class="checkout-form" id="checkoutSection">
          ...
          <div class="form-group">
            ...
            <input type="text" id="oName" value="<?php echo e(auth()->user()->name ?? ''); ?>" placeholder="Full name" />
          </div>
          <div class="form-group">
            <label>Phone *</label>
          ...
          <div class="form-group">
            <label>Email</label>
            <input type="email" id="oEmail" value="<?php echo e(auth()->user()->email ?? ''); ?>" placeholder="your@email.com" />
          </div>
        ...
        <div class="order-success" id="orderSuccess" style="display:none;">
          ...
          <a href="<?php echo e(route('products.index')); ?>" class="btn btn-primary btn-full" style="margin-top:1rem;">Continue Shopping</a>
        </div>
      </div>
...
<script>
  ...
  function placeOrder() {
    ...
    fetch('<?php echo e(route("checkout.place")); ?>', {
      method: 'POST',
      headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pamod\Downloads\forttune-laravel\forttune-laravel\resources\views/frontend/cart.blade.php ENDPATH**/ ?>